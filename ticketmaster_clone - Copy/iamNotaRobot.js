function pxLang(a) {if (a) a = a.toLowerCase();const m={en:"en","en-us":"en","it":"it","it-it":"it","it-ch":"it","fr":"fr","fr-ca":"fr-ch","fr-fr":"fr","es-mx":"es"};var b = m[a];if (!b) b = 'en';return b;}
function getBaseUrl() {
